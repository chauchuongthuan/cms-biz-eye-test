...
import { DigitopEditorComponent } from "./components/digitop-editor/DigitopEditorComponent";
...
@NgModule({
   ...
   imports: [CommonModule, AntdModule, IconsProviderModule, CKEditorModule, FormsModule],
