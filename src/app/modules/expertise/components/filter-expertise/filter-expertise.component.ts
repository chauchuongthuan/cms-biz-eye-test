...
@Component({
   selector: "app-filter-expertise",
   templateUrl: "./filter-expertise.component.html",
   styleUrls: ["./filter-expertise.component.scss"],
})
export class FilterExpertiseComponent implements OnInit {
