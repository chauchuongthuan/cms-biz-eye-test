...
export class InterestComponent implements OnInit {
   @ViewChild("actionComponent") actionComponent: CreateEditInterestComponent;
   ...
   getInterest(params: HttpParams) {
      ...
      this.interestService.getInterest(params).subscribe((data) => {
   ...
   exportExcel() {
      this.interestService.exportInterest(this.params);
   }

   changeStatus(id: any, $event: any) {
      this.tableLoading = true;
      this.interestService.changeStatus(id, $event).subscribe(
         (data) => {
            this.getInterest(this.params);
         },
         (error) => (this.tableLoading = false),
