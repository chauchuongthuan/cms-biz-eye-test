...
@Component({
  selector: 'app-filter-customer-care-type',
  templateUrl: './filter-customer-care-type.component.html',
})
export class FilterCustomerCareTypeComponent implements OnInit {
