...
@Component({
  selector: 'app-filter-post-award',
  templateUrl: './filter-post-award.component.html',
  styleUrls: ['./filter-post-award.component.scss']
})
export class FilterPostAwardComponent implements OnInit {
