...
@Component({
  selector: 'app-filter-customer-care-list',
  templateUrl: './filter-customer-care-list.component.html',
})
export class FilterCustomerCareListComponent implements OnInit {
